...
import { addPost, cancelEditPost, finishEditPost, updatePost } from '../blog.slice'
...
const CreatePost = () => {
  ...
  const { editingPost } = useSelector((state: RootState) => state.blogReducer)
  ...
  const handleCancel = () => dispatch(cancelEditPost())

  return (
    <form className='p-20' onSubmit={handleSubmit} onReset={handleCancel}>
      <div className='mb-6'>
      ...
      <div className='mb-6'>
        ...
        <input
          ...
          required
          value={formData.featureImg}
          onChange={(event) => setFormData((prev) => ({ ...prev, featureImg: event.target.value }))}
        />
      </div>
      <div className='mb-6'>
        <div>
